        ...
        {showAddForm && (
          <div className="bg-white border border-border rounded-lg p-4 mb-4 shadow-md">
            ...
            <div className="mb-3">
              ...
              >
                {showBarcodeScanner ? "Tutup Scanner" : "📷 Scan Barcode Produk"}
              </button>
            </div>
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    onChange={(e) =>
                      setNewProductForm({ ...newProductForm, barcode: e.target.value })
                    }
                    onKeyDown={(e) => {
                    ...
                    className="flex-1 px-3 py-2 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary bg-gray-50"
                    placeholder="Ketik barcode lalu Enter atau klik Cari"
                  />
                  <button
                    type="button"
                    onClick={() => {
                    ...
                    className="px-4 py-2 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition disabled:opacity-50 disabled:cursor-not-allowed text-sm whitespace-nowrap"
                  >
                    Cari
                  </button>
                </div>
